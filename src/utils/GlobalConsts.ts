...
// --- Main Sheet ---
const USER_STARTING_ROW: number = 7;
...
const EXPENDITURES_COL: number = 5;
const INVESTMENT_RETURNS_COL: number = 6;

// investments
const INITIAL_DEPOSIT_COL: number = 7;
const DATE_DEPOSIT_COL: number = 8;
const GROSS_INVESTMENT_GAIN_COL: number = 9;
const NET_INVESTMENT_GAIN_COL: number = 10;
const NET_PERCENTAGE_GAIN_COL: number = 11;

// --- Services Sheet ---
const DEFAULT_SERVICES_SHEET: string = "Services";
const SERVICES_ROW_START: number = 3;
...
const SETTINGS_ROW_START: number = 4;
...
// --- Transaction Sheet ---
const DEFAULT_TRANSACTIONS_SHEET: string = "Transactions";
const TRANSACTIONS_ROW_START: number = 3;

// -- Fill Names Utils ---
const STARTING_CELL: string = "A7";
const SHEET_CELL_NAME: string = "A2";
...
const TIMESTAMP_CELL: string = "A5";
